package ru.rtlabs.ebs.reference.receiver.client.deactivation;
...
import ru.rtlabs.ebs.reference.receiver.client.deactivation.handler.impl.DeactivationHandler;
...
public class DeactivationMain {

  private static final Logger LOGGER = LoggerFactory.getLogger(DeactivationMain.class);
  ...
  public static void main(String[] args) {
    try {
      DeactivationConfig config = parseArgs(args);
      IDeactivationHandler handler = new DeactivationHandler(config);
   ...
   * @param args command line arguments
   */
  private static DeactivationConfig parseArgs(String[] args)
    ...
    return ConfigParser
        .createConfig(Utils.getConfigs(configPath), DeactivationConfig.class);
  }
