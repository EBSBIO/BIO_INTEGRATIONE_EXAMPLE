...
public final class Utils {
  ...
  /**
   * Функция для парсинга аргуметов командной строки. Возвращает пару
   * {@link ru.rtlabs.ebs.reference.receiver.service.utils.Arguments}, содержащую пути до файла
   * конфигурации и файла настроек для log4j.
   *
